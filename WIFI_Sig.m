...
load WIFI_PUSH_PULL_5.mat
sig = conj_mult_pca;
data_reshape=sig;
sz=size(data_reshape);
time=length(data_reshape)/1000;
dt=1/1000;
t=0:dt:time-dt;
fs=1000;
FS=fs;
...
tt=t;
figure;
clims = [max(max(20*log10((abs(spc_RS)))))-clims_lim-10,max(max(20*log10((abs(spc_RS)))))];
...
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp3_breheart_RS_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp2_heart_MSST_win',num2str(winlen),'.pdf');
...
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
%%axese('Position',[x11 y11 x22-x11 y22-y11],'EdgeColor','red','%linewidth',3);
%rectangle('Position',[x1 y1 x2-x1 y2-y1],'EdgeColor','red','%linewidth',3);
%line([x11,x2],[y22,y1],'color','r','%linewidth',2,'%lineStyle','-.')
%line([x22,x2],[y22,y2],'color','r','%linewidth',2,'%lineStyle','-.')
%axes('Position',[0.16,0.6,0.3,0.3]);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp3_breheart_STFT_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp2_heart_STFT_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
%% SST
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp3_breheart_SST_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp2_heart_SST_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp3_breheart_SET_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp2_heart_SET_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp3_breheart_MSST_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp2_heart_MSST_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp3_breheart_TFA-Net');
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_wifi\','exp2_heart_TFA-Net','.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);