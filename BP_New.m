...
line([x11,x1],[y22,y1],'color','r','Linewidth',2,'LineStyle','-.')
line([x22,x2],[y22,y1],'color','r','Linewidth',2,'LineStyle','-.')
axes('Position',[0.3,0.568,0.49,0.34]);
imagesc(tt,yaxis,20*log10(fftshift(abs(spc_RS),1)),clims);
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('..\fig_set_BP\','exp3_breheart_RS_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('..\fig_set_BP\','exp2_heart_MSST_win',num2str(winlen),'.pdf');
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('..\fig_set_BP\','exp3_breheart_GWarblet');
saveas(gcf, fname);
...
% Spec=flipud(Spec);
% Spec= fliplr(Spec);  % 沿x轴翻转数据矩阵
figure;
clims = [max(max(20*log10((abs(Spec)))))-clims_lim-20,max(max(20*log10((abs(Spec)))))];
imagesc(t,yaxis,20*log10((abs(Spec))),clims);
set(gca,'ydir','normal')
ylim([ylim_low ylim_max])
title(strcat('SPWVD'))
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('..\fig_set_BP\','exp3_breheart_SPWVD');
saveas(gcf, fname);
...
% set(gca,'ydir','normal')
% set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
% fname=strcat('..\fig_set_BP\','exp3_breheart_CWT');
% saveas(gcf, fname);
%% STFT
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('..\fig_set_BP\','exp3_breheart_STFT_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('..\fig_set_BP\','exp2_heart_STFT_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
%% SST
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('..\fig_set_BP\','exp3_breheart_SST_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('..\fig_set_BP\','exp2_heart_SST_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('..\fig_set_BP\','exp3_breheart_SET_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('..\fig_set_BP\','exp2_heart_SET_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('..\fig_set_BP\','exp3_breheart_MSST_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('..\fig_set_BP\','exp2_heart_MSST_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('..\fig_set_BP\','exp3_breheart_TFA-Net');
saveas(gcf, fname);
% fname=strcat('..\fig_set_BP\','exp2_heart_TFA-Net','.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);