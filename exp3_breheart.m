...
load IEEEDataPort.mat
PPG = Data.Day1.Participant1.OriLegX;
data_reshape=sig.';
...
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp3_breheart_RS_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp2_heart_MSST_win',num2str(winlen),'.pdf');
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp3_breheart_GWarblet');
saveas(gcf, fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp3_breheart_SPWVD');
saveas(gcf, fname);
...
% set(gca,'ydir','normal')
% set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp3_breheart_CWT');
% saveas(gcf, fname);
%% STFT
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp3_breheart_STFT_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp2_heart_STFT_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
%% SST
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp3_breheart_SST_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp2_heart_SST_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp3_breheart_SET_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp2_heart_SET_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp3_breheart_MSST_win',num2str(winlen));
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp2_heart_MSST_win',num2str(winlen),'.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp3_breheart_TFA-Net');
saveas(gcf, fname);
% fname=strcat('D:\Project\TFA\TFA-Net-main - merge - winlength\fig_set_breathbeat\','exp2_heart_TFA-Net','.pdf');
% export_fig(gcf , '-eps' , '-r300' , '-painters' , fname);