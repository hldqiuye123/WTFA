...
% 文件路径
load blended_data.mat
file_path = 'D:\Chrome下载\sEMG_Larynx_Dataset\sEMG_Larynx_Dataset\P9_S1\15_twist-reach-walk.csv';
FS=250;
% 读取第6列。参数 '0,5' 指定从第0行第5列开始（MATLAB的索引是从0开始的）
% data = csvread(file_path);
sp=2768-600;
ep=2768;
v1p = blended_data(sp:ep,3,10);
v1p =v1p-mean(v1p);
data_reshape= v1p;
TS=1/250;
...
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
fname=strcat('D:\Project\TFA\TFA-Net-main\TFA-Net_inference\figs\','exp2_voice_STFT_win',num2str(winlen));
%saveas(gcf, fname);
...
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
fname=strcat('D:\Project\TFA\TFA-Net-main\TFA-Net_inference\figs\','exp2_voice_GWarblet_win',num2str(winlen));
%saveas(gcf, fname);
...
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
fname=strcat('D:\Project\TFA\TFA-Net-main\TFA-Net_inference\figs\','exp2_voice_PSWVD_win',num2str(winlen));
%saveas(gcf, fname);
...
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
fname=strcat('D:\Project\TFA\TFA-Net-main\TFA-Net_inference\figs\','exp2_voice_SST_win',num2str(winlen));
%saveas(gcf, fname);
...
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
fname=strcat('D:\Project\TFA\TFA-Net-main\TFA-Net_inference\figs\','exp2_voice_SET_win',num2str(winlen));
%saveas(gcf, fname);
...
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
fname=strcat('D:\Project\TFA\TFA-Net-main\TFA-Net_inference\figs\','exp2_voice_MSST_win',num2str(winlen));
%saveas(gcf, fname);
...
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
fname=strcat('D:\Project\TFA\TFA-Net-main\TFA-Net_inference\figs\','exp2_voice_RS_win',num2str(winlen));
%saveas(gcf, fname);
...
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
fname=strcat('D:\Project\TFA\TFA-Net-main\TFA-Net_inference\figs\','exp2_voice_TFA');
%saveas(gcf, fname);
